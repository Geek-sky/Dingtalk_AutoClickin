...
########################################################################################################################
phone_local="yes"
# phone_adb_ip="192.168.3.101"
# phone_adb_port="5037"
# phone_model="SM-G986U"
dingding_package="com.alibaba.android.rimet/com.alibaba.android.rimet.biz.LaunchHomeActivity"
...
phone_operating(){
    ...
    adb shell input swipe 450 1900 350 1000 1000
    adb shell am start -n com.alibaba.android.rimet/com.alibaba.android.rimet.biz.LaunchHomeActivity   # open dingtalk
